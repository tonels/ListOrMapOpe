...
/**
 flatMap可以将对象的某一列，切分或者其他处理
 */
public class List_flatMap {

    public static void main(String[] args) {

        Book b1 = new Book().setBookId(1).setBookName("霍,乱").setPrice(20.56);
        Book b2 = new Book().setBookId(2).setBookName("百年孤独").setPrice(30.36);
        Book b3 = new Book().setBookId(3).setBookName("盛世,煮酒").setPrice(31.26);
        Book b4 = new Book().setBookId(4).setBookName("小熊和李").setPrice(30);
        Book b5 = new Book().setBookId(5).setBookName("周,一十五").setPrice(56);
